...
export const RESTAURANTS_URL = process.env.SERVER_URL + ':' + process.env.SERVER_PORT + '/restaurants.json';
export const CUISINES_URL = process.env.SERVER_URL + ':' + process.env.SERVER_PORT + '/cuisines.json';
